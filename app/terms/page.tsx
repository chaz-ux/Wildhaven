...
const sections = [
  ...
  { title: 'Changes to Itinerary', content: 'Zazu Safaris reserves the right to modify itineraries due to weather, safety concerns, wildlife activity, or factors beyond our control. Every change is made to optimise your experience, not reduce it.' },
  ...
  { title: 'Liability', content: 'Zazu Safaris acts as agent for accommodation providers, airlines, and ground operators. While we vet every supplier rigorously, we cannot be held liable for their acts or omissions. All guests must have valid travel insurance.' },
  { title: 'Conservation Levy', content: '2% of every booking is directed to the Zazu Conservation Fund. This is included in your quoted price — no hidden charges.' },
]
