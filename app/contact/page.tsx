        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div>
            ...
            <div className="glass p-6 rounded-sm space-y-4">
              ...
              <a href="mailto:hello@wildhaven.co.ke" className="flex items-center gap-3 text-sm text-ivory/60 hover:text-ivory transition-colors group">
