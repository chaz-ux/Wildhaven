...
const sections = [
  ...
  { title: 'Your Rights', content: 'You have the right to access, correct, or delete your personal data at any time. Email hello@zazusafaris.com with the subject "Data Request" and we will respond within 48 hours.' },
