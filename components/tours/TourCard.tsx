...
export default function TourCard({ tour, priority = false }: TourCardProps) {
  ...
  return (
    <div className="tour-card rounded-sm overflow-hidden bg-charcoal-mid border border-white/6">
      {/* Main card links to detail page */}
      <Link href={`/safaris/${tour.slug}`} className="block group">
        {/* Image */}
      ...
      <div className="px-5 pb-5 flex justify-end">
        <Link 
          ...
          className="w-8 h-8 rounded-full border border-gold/25 flex items-center justify-center text-gold hover:bg-gold hover:border-gold transition-all duration-300">
